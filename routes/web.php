...
<<<<<<< HEAD
    Route::post('/mise_en_ligne_logement', [Logement::class, 'mise_en_ligne_logement'])->name('mise_en_ligne_logement')->middleware(['auth', 'isProprietaire']);
...
>>>>>>> 5bca079dbe9d4c915ecdf2409e839ddbff09421a
});
