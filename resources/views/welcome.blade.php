            ...
            <script>
                ...
                function filtrePrix(prixMin, prixMax) {
                    ...
                    tabCard.forEach((carte) => {
                        ...
                        let id = carte.dataset.id; // récupère l'id de la carte
                        ...
                        if(prix >= prixMin && prix <= prixMax && (typeSelectionne === "Aucun" || type === typeSelectionne)) {
                            ...
                            markers[id].addTo(mymap); // ajoute le marqueur à la carte
                            counter++;
                        } else {
                            carte.style.display = "none";
                            mymap.removeLayer(markers[id]); // retire le marqueur de la carte
                        }
                    });
