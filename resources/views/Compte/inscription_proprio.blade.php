        ...
        <div class="row lapage">
            <div class="col-md-6">
                ...
                <select id="civilite_pers" name="civilite_pers" class="form-control">
                    ...
                    <input type="text" id="nom_pers" name="nom_pers" placeholder="Entrez votre nom" class="form-control" pattern="[A-Za-z\-'\s]+" required>
                    ...
                    <input type="text" id="pseudo_pers" name="pseudo_pers" placeholder="Choisissez un pseudo" class="form-control" required>
