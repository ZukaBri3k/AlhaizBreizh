        ...
        <div class="row lapage">
            <div class="col-md-6">
                ...
                <div class="form-container">
                    ...
                    <input type="text" id="nom_pers" name="nom_pers" placeholder="Entrez votre nom" class="form-control" require>

                    <label for="prenom_pers">*Prénom:</label>
                    <input type="text" id="prenom_pers" name="prenom_pers" placeholder="Entrez votre prénom" class="form-control" require>
                    ...
                    <input type="text" id="ville_pers" name="ville_pers" placeholder="Entrez votre ville" class="form-control" require>
            ...
            <div class="col-md-6 divider">
                ...
                <div class="form-container">
                    ...
                    <input type="password" id="confirmerMotDePasse" name="confirmerMotDePasse"
                        placeholder="Confirmez votre mot de passe" class="form-control" require>
