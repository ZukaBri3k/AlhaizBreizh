        ...
        <div class="row lapage">
            <div class="col-md-6">
                ...
                <div class="form-container">
                    ...
                    <input type="text" id="prenom_pers" name="prenom_pers" placeholder="Entrez votre prénom" class="form-control pasChiffre" value="{!! $personnes->prenom_pers !!}" pattern="[A-Za-z\-'\s]+" 
                    ...
                    <input type="text" id="ville_pers" name="ville_pers" placeholder="Entrez votre ville" class="form-control pasChiffre" value="{!! $personnes->ville_pers !!}" 
                        maxlength="60" required>

                    <label for="pays_pers">*Pays:</label>
                    <input type="text" id="pays_pers" name="pays_pers" placeholder="Entrez votre pays" value="{!! $personnes->pays_pers !!}" class="form-control pasChiffre" required>
                    <script>
